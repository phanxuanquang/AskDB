...
namespace DatabaseAnalyzer
{
    public static class Analyzer
    {
        ...
        public static async Task<SqlCommander> GetSql(string apiKey, string question, DatabaseType type)
        {
            ...
            promptBuilder.AppendLine($"- Output: This is your response to my input. If my input cannot be converted into a {databaseType} query or you find it is not relevant to the table structure in the database I provided, or you find it is a dangerous query (INSERT or UPDATE or DELETE or make changes in the database), please respond that my request is dangerouse and why. Otherwise, please return the corresponding {databaseType} query.");
